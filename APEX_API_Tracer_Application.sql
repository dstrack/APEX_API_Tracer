...
--   Date and Time:   00:24 Monday August 23, 2021
--   Exported By:     DIRK
--   Flashback:       0
...
,p_last_upd_yyyymmddhh24miss=>'20210823002432'
...
'                    TO_CLOB(''CREATE OR REPLACE '' || SYNONYM_STATS || '';'') '))
);
end;
/
begin
...
'	end NL;',
'    FUNCTION INDENT(p_Text VARCHAR2, p_Indent PLS_INTEGER'))
);
null;
end;
/
