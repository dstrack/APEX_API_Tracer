...
--   Date and Time:   19:49 Saturday March 11, 2023
--   Exported By:     DIRK
--   Flashback:       0
...
,p_application_group=>31070566381908972
,p_application_group_name=>'Productivity Applications'
...
,p_last_upd_yyyymmddhh24miss=>'20230311194845'
...
,p_last_updated_by=>'DIRK'
,p_last_upd_yyyymmddhh24miss=>'20230311153701'
);
...
'select Synonym_Name,Package_Owner,Package_Name,Is_Enabled_Switch,Is_Enabled,',
'    Grant_Stats,Revoke_Stats,Synonym_Stats,Affected_Objects,Global_Variables_Count,Error_Count ',
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(263067481637062025)
,p_db_column_name=>'GRANT_STATS'
,p_display_order=>90
,p_column_identifier=>'K'
,p_column_label=>'Grant Stats'
,p_allow_sorting=>'N'
,p_allow_ctrl_breaks=>'N'
,p_allow_aggregations=>'N'
,p_allow_computations=>'N'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(263067582812062026)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(263067669030062027)
,p_db_column_name=>'SYNONYM_STATS'
,p_display_order=>110
,p_column_identifier=>'M'
,p_column_label=>'Synonym Stats'
,p_allow_sorting=>'N'
,p_allow_ctrl_breaks=>'N'
,p_allow_aggregations=>'N'
,p_allow_computations=>'N'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(263067719819062028)
,p_db_column_name=>'AFFECTED_OBJECTS'
,p_display_order=>120
,p_column_identifier=>'N'
,p_column_label=>'Affected Objects'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(263068580586062036)
,p_db_column_name=>'GLOBAL_VARIABLES_COUNT'
,p_display_order=>130
,p_column_identifier=>'P'
,p_column_label=>'Global Variables Count'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
);
...
,p_name=>'Tracing Code for Packages'
...
'    p_Package_Owner=>:P1_PACKAGE_OWNER,',
...
'    p_Logging_Exception_Enabled=>:P1_LOGGING_EXCEPTION,',
'    p_Logging_API_Exception=>:P1_LOGGING_API_EXCEPTION,',
...
'    p_Before_Each_Procedure=>:P1_BEFORE_EACH_PROCEDURE,',
'    p_After_Each_Procedure=>:P1_AFTER_EACH_PROCEDURE,',
'    p_Indent=>:P1_INDENT',
'))',
'order by Subprogram_Id',
'',
'-- P1_PACKAGE_OWNER,P1_PACKAGE_NAME,P1_COMPACT,P1_LOGGING_START,P1_LOGGING_EXCEPTION,P1_USE_CONDITION,P1_INDENT',
''))
,p_display_when_condition=>'P1_SECTION'
,p_display_when_cond2=>'LOCALE'
,p_display_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_ajax_enabled=>'Y'
,p_ajax_items_to_submit=>'P1_PACKAGE_OWNER,P1_PACKAGE_NAME,P1_COMPACT,P1_LOGGING_START,P1_LOGGING_EXCEPTION,P1_USE_CONDITION,P1_INDENT'
...
,p_query_type=>'SQL'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select Synonym_Owner,Synonym_Name,Package_Owner,Package_Name,Is_Enabled_Switch,Is_Enabled,',
'    Grant_Stats,Revoke_Stats,Synonym_Stats,Affected_Objects,Global_Variables_Count,Error_Count ',
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(263067929561062030)
,p_db_column_name=>'GRANT_STATS'
,p_display_order=>90
,p_column_identifier=>'K'
,p_column_label=>'Grant Stats'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(263068062136062031)
,p_db_column_name=>'REVOKE_STATS'
,p_display_order=>100
,p_column_identifier=>'L'
,p_column_label=>'Revoke Stats'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(263068144757062032)
,p_db_column_name=>'SYNONYM_STATS'
,p_display_order=>110
,p_column_identifier=>'M'
,p_column_label=>'Synonym Stats'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(263068278422062033)
,p_db_column_name=>'AFFECTED_OBJECTS'
,p_display_order=>120
,p_column_identifier=>'N'
,p_column_label=>'Affected Objects'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(263068489745062035)
,p_db_column_name=>'GLOBAL_VARIABLES_COUNT'
,p_display_order=>130
,p_column_identifier=>'P'
,p_column_label=>'Global Variables Count'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(263976446779306716)
,p_db_column_name=>'SYNONYM_OWNER'
,p_display_order=>140
,p_column_identifier=>'Q'
,p_column_label=>'Synonym Owner'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_rpt(
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(264254247911014275)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(264103248232342068)
,p_application_user=>'APXWS_ALTERNATIVE'
,p_name=>'APEX'
,p_report_seq=>10
,p_report_alias=>'2641033'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'SYNONYM_NAME:IS_ENABLED_SWITCH:PACKAGE_OWNER:PACKAGE_NAME:ERROR_COUNT:GRANT_STATS:REVOKE_STATS:SYNONYM_STATS:AFFECTED_OBJECTS:'
,p_sort_column_1=>'SYNONYM_NAME'
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(264103651550342085)
,p_report_id=>wwv_flow_api.id(264103248232342068)
,p_condition_type=>'FILTER'
,p_allow_delete=>'Y'
,p_column_name=>'SYNONYM_NAME'
,p_operator=>'like'
,p_expr=>'APEX%'
,p_condition_sql=>'"SYNONYM_NAME" like #APXWS_EXPR#'
,p_condition_display=>'#APXWS_COL_NAME# #APXWS_OP_NAME# ''APEX%''  '
,p_enabled=>'Y'
);
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(264104048742342086)
,p_report_id=>wwv_flow_api.id(264103248232342068)
,p_condition_type=>'FILTER'
,p_allow_delete=>'Y'
,p_column_name=>'IS_ENABLED'
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(264105096516346483)
,p_application_user=>'APXWS_ALTERNATIVE'
,p_name=>'DBMS'
,p_report_seq=>10
,p_report_alias=>'2641051'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>100
,p_report_columns=>'SYNONYM_NAME:IS_ENABLED_SWITCH:PACKAGE_OWNER:PACKAGE_NAME:ERROR_COUNT:GRANT_STATS:REVOKE_STATS:SYNONYM_STATS:AFFECTED_OBJECTS:'
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(264105408953346484)
,p_report_id=>wwv_flow_api.id(264105096516346483)
,p_condition_type=>'FILTER'
,p_allow_delete=>'Y'
,p_column_name=>'IS_ENABLED'
,p_operator=>'='
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(264105808368346484)
,p_report_id=>wwv_flow_api.id(264105096516346483)
,p_condition_type=>'FILTER'
,p_allow_delete=>'Y'
,p_column_name=>'SYNONYM_NAME'
...
,p_expr=>'DBMS%'
,p_condition_sql=>'"SYNONYM_NAME" like #APXWS_EXPR#'
,p_condition_display=>'#APXWS_COL_NAME# #APXWS_OP_NAME# ''DBMS%''  '
,p_enabled=>'Y'
);
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(264106716034351222)
,p_application_user=>'APXWS_ALTERNATIVE'
,p_name=>'UTL'
,p_report_seq=>10
,p_report_alias=>'2641068'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'SYNONYM_NAME:PACKAGE_OWNER:PACKAGE_NAME:IS_ENABLED_SWITCH:ERROR_COUNT:GRANT_STATS:REVOKE_STATS:SYNONYM_STATS:AFFECTED_OBJECTS:'
,p_sort_column_1=>'SYNONYM_NAME'
,p_sort_direction_1=>'ASC'
,p_sort_column_2=>'0'
,p_sort_direction_2=>'ASC'
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(264107168903351223)
,p_report_id=>wwv_flow_api.id(264106716034351222)
,p_condition_type=>'FILTER'
,p_allow_delete=>'Y'
,p_column_name=>'SYNONYM_NAME'
,p_operator=>'like'
,p_expr=>'UTL%'
,p_condition_sql=>'"SYNONYM_NAME" like #APXWS_EXPR#'
,p_condition_display=>'#APXWS_COL_NAME# #APXWS_OP_NAME# ''UTL%''  '
,p_enabled=>'Y'
);
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(264254737303039486)
,p_application_user=>'APXWS_ALTERNATIVE'
,p_name=>'LOCAL'
,p_report_seq=>10
,p_report_alias=>'2642548'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'SYNONYM_OWNER:SYNONYM_NAME:IS_ENABLED_SWITCH:PACKAGE_OWNER:PACKAGE_NAME:ERROR_COUNT:GRANT_STATS:REVOKE_STATS:SYNONYM_STATS:AFFECTED_OBJECTS:'
,p_sort_column_1=>'SYNONYM_NAME'
,p_sort_direction_1=>'ASC'
,p_sort_column_2=>'0'
,p_sort_direction_2=>'ASC'
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(264255100104039486)
,p_report_id=>wwv_flow_api.id(264254737303039486)
,p_condition_type=>'FILTER'
,p_allow_delete=>'Y'
,p_column_name=>'IS_ENABLED'
,p_operator=>'='
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(264255527126039487)
,p_report_id=>wwv_flow_api.id(264254737303039486)
,p_condition_type=>'FILTER'
,p_allow_delete=>'Y'
,p_column_name=>'SYNONYM_OWNER'
,p_operator=>'!='
,p_expr=>'PUBLIC'
,p_condition_sql=>'"SYNONYM_OWNER" != #APXWS_EXPR#'
,p_condition_display=>'#APXWS_COL_NAME# != ''PUBLIC''  '
,p_enabled=>'Y'
);
wwv_flow_api.create_page_plug(
...
'    S.DEST_OBJECT_EXISTS, S.CONFLICTING_OBJECT_EXISTS, S.ADMIN_GRANT_STAT,',
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(263975862293306710)
,p_db_column_name=>'ADMIN_GRANT_STAT'
,p_display_order=>190
,p_column_identifier=>'R'
,p_column_label=>'Admin Grant Stat'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_rpt(
...
,p_is_default=>'Y'
,p_display_rows=>1000
,p_report_columns=>'OBJECT_TYPE:OBJECT_NAME:IS_ENABLED_SWITCH:DEST_OBJECT_TYPE:CONFLICTING_OBJECT_EXISTS:DEST_OBJECT_EXISTS:GRANT_STAT:CREATE_STAT::ADMIN_GRANT_STAT'
...
,p_plug_display_when_condition=>'P1_SECTION'
,p_plug_display_when_cond2=>'APEX:PUBLIC:LOCALE'
,p_attribute_01=>'N'
,p_attribute_02=>'TEXT'
,p_attribute_03=>'Y'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(263975981630306711)
,p_plug_name=>'Required Privileges'
,p_region_template_options=>'#DEFAULT#:t-Alert--horizontal:t-Alert--defaultIcons:t-Alert--warning'
,p_plug_template=>wwv_flow_api.id(261818164330419209)
,p_plug_display_sequence=>60
,p_include_in_reg_disp_sel_yn=>'Y'
,p_plug_display_point=>'BODY'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<pre>',
'-- Execute the following grant staements as ADMIN to enable publishing of a schema: --',
'',
'GRANT CREATE ANY SYNONYM TO &OWNER.;',
'GRANT DROP ANY SYNONYM TO &OWNER.;',
'GRANT CREATE ANY VIEW TO &OWNER.;',
'GRANT DROP ANY VIEW TO &OWNER.;',
'GRANT MERGE ANY VIEW TO &OWNER.;',
'',
'</pre>'))
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
...
,p_button_template_options=>'#DEFAULT#:t-Button--padRight:t-Button--padTop:t-Button--padBottom'
,p_button_template_id=>wwv_flow_api.id(261903106003419254)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Submit Changes'
,p_button_position=>'REGION_TEMPLATE_EDIT'
,p_button_condition=>'P1_SECTION'
,p_button_condition2=>'LOCALE'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(263065591784062006)
,p_button_sequence=>60
,p_button_plug_id=>wwv_flow_api.id(261518834760997850)
,p_button_name=>'PACKAGE_RECORD_TYPES'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#:t-Button--padTop'
,p_button_template_id=>wwv_flow_api.id(261903106003419254)
,p_button_image_alt=>'Package Record Types'
,p_button_position=>'RIGHT_OF_IR_SEARCH_BAR'
...
,p_prompt=>'Package Name (Synonyms)'
,p_display_as=>'NATIVE_POPUP_LOV'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
'SELECT SYN.SYNONYM_NAME, SYN.TABLE_NAME',
...
'UNION ',
'SELECT OBJ.OBJECT_NAME, OBJ.OBJECT_NAME',
...
,p_begin_on_new_line=>'N'
,p_display_when=>'P1_SECTION'
,p_display_when2=>'APEX:PUBLIC:LOCALE'
...
'<pre>',
'PL/SQL Code. Start of If-Condition to enable or disable logging at runtime.',
'Example:',
'if apex_application.g_debug then',
'',
'-- or --',
'$IF package_name.g_debug >= 12 $THEN',
'',
'</pre>'))
,p_attribute_01=>'N'
,p_attribute_02=>'N'
...
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<pre>',
'PL/SQL Code. End of If-Condition to enable or disable logging at runtime.',
'Example:',
'end if;',
'',
'-- or --',
...
,p_field_template=>wwv_flow_api.id(261902054420419252)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Indention of the generated PL/SQL code. Count of spaces at the beginning of each text line.'
,p_attribute_01=>'0'
,p_attribute_02=>'24'
...
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<pre>',
'Logging Start Call at function start with IN and IN/OUT Arguments. PL/SQL Code.',
'',
'Available Substitution Strings:',
'%s                -- Enquoted logged Message',
'#PROCEDURE_NAME#  -- Name of the Procedure or Function',
'#PACKAGE_NAME#    -- Name of the Package',
'#SUBPROGRAM#      -- Package.Procedure',
'#RETURN_TYPE#     -- Datatype of function return value.',
'#PROCEDURE_TYPE#  -- Type is ''Procedure'' or ''Function''',
'#SYSDATE#         -- Current Date in the format YYYYMMDD',
'',
'Example:',
'apex_debug.log_long_message(p_message=>''''API call: '''' || %s, p_level=>5);',
'</pre>'))
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'N'
...
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<pre>',
'Logging Finish Call at function exit with OUT and IN/OUT Arguments. PL/SQL Code.',
'',
'Available Substitution Strings:',
'%s                -- Enquoted logged Message',
'#PROCEDURE_NAME#  -- Name of the Procedure or Function',
...
'',
'Example:',
'apex_debug.log_long_message(p_message=>''''API exit: '''' || %s, p_level=>5);',
'</pre>'))
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'N'
...
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<pre>',
'Logging API Call at function exit with IN, IN/OUT and OUT Arguments. PL/SQL Code.',
'',
'Available Substitution Strings:',
'%s                -- Enquoted logged Message',
'#PROCEDURE_NAME#  -- Name of the Procedure or Function',
...
'',
'Example:',
'apex_debug.log_long_message(p_message=>''''API: '''' || %s, p_level=>5);',
'</pre>'))
,p_attribute_01=>'Y'
,p_attribute_02=>'N'
,p_attribute_03=>'N'
...
,p_field_template=>wwv_flow_api.id(261902054420419252)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>'Name of the PL/SQL variable for the function return value,'
,p_attribute_01=>'N'
,p_attribute_02=>'N'
,p_attribute_04=>'TEXT'
,p_attribute_05=>'NONE'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(263069317231062044)
,p_name=>'P1_LOGGING_API_EXCEPTION'
,p_is_required=>true
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(525974396928751506)
,p_prompt=>'Logging Api Exception'
,p_display_as=>'NATIVE_TEXTAREA'
,p_cSize=>30
,p_cMaxlength=>500
,p_cHeight=>5
...
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<pre>',
'Logging API Exception PL/SQL Code.',
'Available Substitution Strings:',
'%s                -- Enquoted logged Message',
'#PROCEDURE_NAME#  -- Name of the Procedure or Function',
'#PACKAGE_NAME#    -- Name of the Package',
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(263069526323062046)
,p_name=>'P1_LOGGING_EXCEPTION'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(525974396928751506)
,p_prompt=>'Logging of Procedure Exception'
,p_display_as=>'NATIVE_YES_NO'
,p_display_when=>'P1_SECTION'
,p_display_when2=>'LOCALE'
,p_display_when_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(263069983639062050)
,p_name=>'P1_BEFORE_EACH_PROCEDURE'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(525974396928751506)
,p_prompt=>'Before Each Procedure'
,p_display_as=>'NATIVE_TEXTAREA'
,p_cSize=>30
,p_cMaxlength=>5000
,p_cHeight=>5
...
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<pre>',
'PL/SQL Code that is inserted before each procedure or function. ',
'',
'Available Substitution Strings:',
'#PROCEDURE_NAME#  -- Name of the Procedure or Function',
'#PACKAGE_NAME#    -- Name of the Package',
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(263974999036306701)
,p_name=>'P1_AFTER_EACH_PROCEDURE'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(525974396928751506)
,p_prompt=>'After Each Procedure'
,p_display_as=>'NATIVE_TEXTAREA'
,p_cSize=>30
,p_cMaxlength=>5000
,p_cHeight=>5
...
,p_computation=>'NVL(APEX_UTIL.GET_PREFERENCE(''API_TRACER_COMPACT'',:APP_USER), ''N'')'
...
,p_computation_point=>'BEFORE_BOX_BODY'
,p_computation_type=>'PLSQL_EXPRESSION'
,p_computation=>'NVL(APEX_UTIL.GET_PREFERENCE(''API_TRACER_USE_CONDITION'',:APP_USER), ''Y'')'
...
,p_computation_point=>'BEFORE_BOX_BODY'
,p_computation_type=>'PLSQL_EXPRESSION'
,p_computation=>'NVL(APEX_UTIL.GET_PREFERENCE(''API_TRACER_LOGGING_START'',:APP_USER), ''N'')'
,p_compute_when=>'P1_LOGGING_START'
,p_compute_when_type=>'ITEM_IS_NULL'
);
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(263069643083062047)
,p_computation_sequence=>60
,p_computation_item=>'P1_LOGGING_EXCEPTION'
,p_computation_point=>'BEFORE_BOX_BODY'
,p_computation_type=>'PLSQL_EXPRESSION'
,p_computation=>'NVL(APEX_UTIL.GET_PREFERENCE(''API_TRACER_LOGGING_EXCEPTION'',:APP_USER), ''N'')'
,p_compute_when=>'P1_LOGGING_EXCEPTION'
,p_compute_when_type=>'ITEM_IS_NULL'
);
wwv_flow_api.create_page_computation(
...
'NVL(APEX_UTIL.GET_PREFERENCE(''API_TRACER_LOGGING_START_CALL'',:APP_USER), api_trace.c_APEX_Logging_Start_Call)',
''))
...
,p_computation_type=>'PLSQL_EXPRESSION'
,p_computation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'NVL(APEX_UTIL.GET_PREFERENCE(''API_TRACER_LOGGING_FINISH_CALL'',:APP_USER), api_trace.c_APEX_Logging_Exit_Call)',
''))
...
,p_computation_type=>'PLSQL_EXPRESSION'
,p_computation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'NVL(APEX_UTIL.GET_PREFERENCE(''API_TRACER_VARIABLE_NAME'',:APP_USER), ''v_result'')',
''))
...
,p_computation_type=>'PLSQL_EXPRESSION'
,p_computation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'NVL(APEX_UTIL.GET_PREFERENCE(''API_TRACER_LOGGING_API_CALL'',:APP_USER), api_trace.c_APEX_Logging_API_Call)',
''))
,p_compute_when=>'P1_LOGGING_API_CALL'
,p_compute_when_type=>'ITEM_IS_NULL'
);
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(263069431627062045)
,p_computation_sequence=>120
,p_computation_item=>'P1_LOGGING_API_EXCEPTION'
,p_computation_point=>'BEFORE_BOX_BODY'
,p_computation_type=>'PLSQL_EXPRESSION'
,p_computation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'NVL(APEX_UTIL.GET_PREFERENCE(''API_TRACER_LOGGING_API_EXCEPTION'',:APP_USER), api_trace.c_APEX_Logging_API_Exception)',
''))
,p_compute_when=>'P1_LOGGING_API_EXCEPTION'
,p_compute_when_type=>'ITEM_IS_NULL'
);
wwv_flow_api.create_page_computation(
...
,p_computation_type=>'PLSQL_EXPRESSION'
,p_computation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'NVL(APEX_UTIL.GET_PREFERENCE(''API_TRACER_CONDITION_START'',:APP_USER), package_tracer.c_APEX_Condition_Start)',
''))
...
,p_computation_type=>'PLSQL_EXPRESSION'
,p_computation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'NVL(APEX_UTIL.GET_PREFERENCE(''API_TRACER_CONDITION_END'',:APP_USER), package_tracer.c_APEX_Condition_End)',
''))
,p_compute_when=>'P1_CONDITION_END'
,p_compute_when_type=>'ITEM_IS_NULL'
);
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(263975044746306702)
,p_computation_sequence=>150
,p_computation_item=>'P1_BEFORE_EACH_PROCEDURE'
,p_computation_point=>'BEFORE_BOX_BODY'
,p_computation_type=>'PLSQL_EXPRESSION'
,p_computation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'APEX_UTIL.GET_PREFERENCE(''API_TRACER_BEFORE_EACH_PROCEDURE'',:APP_USER)',
''))
);
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(263975185030306703)
,p_computation_sequence=>160
,p_computation_item=>'P1_AFTER_EACH_PROCEDURE'
,p_computation_point=>'BEFORE_BOX_BODY'
,p_computation_type=>'PLSQL_EXPRESSION'
,p_computation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'APEX_UTIL.GET_PREFERENCE(''API_TRACER_AFTER_EACH_PROCEDURE'',:APP_USER)',
''))
);
wwv_flow_api.create_page_computation(
...
,p_computation_type=>'PLSQL_EXPRESSION'
,p_computation=>wwv_flow_string.join(wwv_flow_t_varchar2(
'NVL(APEX_UTIL.GET_PREFERENCE(''API_TRACER_INDENT'',:APP_USER), 8)',
''))
...
,p_condition_element=>'P1_USE_CONDITION'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(263975631656306708)
...
,p_affected_elements=>'P1_CONDITION_START,P1_CONDITION_END'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(263975795461306709)
,p_event_id=>wwv_flow_api.id(262301076537064549)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(263975505417306707)
,p_event_id=>wwv_flow_api.id(262301076537064549)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
begin
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(263069702525062048)
,p_name=>'P1_LOGGING_EXCEPTION - Changed'
,p_event_sequence=>70
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P1_LOGGING_EXCEPTION'
,p_condition_element=>'P1_LOGGING_EXCEPTION'
,p_triggering_condition_type=>'EQUALS'
,p_triggering_expression=>'Y'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(263975329990306705)
,p_event_id=>wwv_flow_api.id(263069702525062048)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P1_LOGGING_API_EXCEPTION'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(263975412962306706)
,p_event_id=>wwv_flow_api.id(263069702525062048)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(263069851454062049)
,p_event_id=>wwv_flow_api.id(263069702525062048)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(263975240043306704)
,p_event_id=>wwv_flow_api.id(263069702525062048)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
'APEX_UTIL.SET_PREFERENCE(''API_TRACER_LOGGING_START'', :P1_LOGGING_START, :APP_USER);',
'APEX_UTIL.SET_PREFERENCE(''API_TRACER_LOGGING_EXCEPTION'', :P1_LOGGING_EXCEPTION, :APP_USER);',
'',
'APEX_UTIL.SET_PREFERENCE(''API_TRACER_COMPACT'', :P1_COMPACT, :APP_USER);',
'APEX_UTIL.SET_PREFERENCE(''API_TRACER_USE_CONDITION'', :P1_USE_CONDITION, :APP_USER);',
'APEX_UTIL.SET_PREFERENCE(''API_TRACER_LOGGING_START_CALL'', :P1_LOGGING_START_CALL, :APP_USER);',
'APEX_UTIL.SET_PREFERENCE(''API_TRACER_LOGGING_FINISH_CALL'', :P1_LOGGING_FINISH_CALL, :APP_USER);',
'APEX_UTIL.SET_PREFERENCE(''API_TRACER_LOGGING_API_CALL'', :P1_LOGGING_API_CALL, :APP_USER);',
'APEX_UTIL.SET_PREFERENCE(''API_TRACER_LOGGING_API_EXCEPTION'', :P1_LOGGING_API_EXCEPTION, :APP_USER);',
'',
'APEX_UTIL.SET_PREFERENCE(''API_TRACER_VARIABLE_NAME'', :P1_VARIABLE_NAME, :APP_USER);',
'APEX_UTIL.SET_PREFERENCE(''API_TRACER_CONDITION_START'', :P1_CONDITION_START, :APP_USER);',
'APEX_UTIL.SET_PREFERENCE(''API_TRACER_CONDITION_END'', :P1_CONDITION_END, :APP_USER);',
'',
'APEX_UTIL.SET_PREFERENCE(''API_TRACER_BEFORE_EACH_PROCEDURE'', :P1_BEFORE_EACH_PROCEDURE, :APP_USER);',
'APEX_UTIL.SET_PREFERENCE(''API_TRACER_AFTER_EACH_PROCEDURE'', :P1_AFTER_EACH_PROCEDURE,:APP_USER);',
'',
'APEX_UTIL.SET_PREFERENCE(''API_TRACER_INDENT'', :P1_INDENT, :APP_USER);'))
...
':P1_LOGGING_API_EXCEPTION := api_trace.c_APEX_Logging_API_Exception;',
':P1_VARIABLE_NAME := ''v_result'';',
...
wwv_flow_api.create_page(
 p_id=>20
,p_user_interface_id=>wwv_flow_api.id(261925670901419279)
,p_name=>'Package Record Types'
,p_page_mode=>'MODAL'
,p_step_title=>'Package Record Types'
,p_autocomplete_on_off=>'OFF'
,p_page_template_options=>'#DEFAULT#:ui-dialog--stretch'
,p_last_updated_by=>'DIRK'
,p_last_upd_yyyymmddhh24miss=>'20210830003407'
);
wwv_flow_api.create_page_plug(
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(263066072859062011)
,p_plug_name=>'Package Record Types'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(261845905561419224)
...
'    T.Type_Name, T.Item_Name, T.Item_Type, T.Item_Sequence, T.Index_By, T.Nested_Table, T.Table_Type, ',
'    T.Type_Object_Type, T.Data_type',
'from MV_PACKAGE_RECORD_TYPES T',
''))
,p_plug_source_type=>'NATIVE_IR'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_plug_display_condition_type=>'ITEM_IS_NOT_NULL'
,p_plug_display_when_condition=>'P20_LAST_REFRESH_DATE'
,p_prn_content_disposition=>'ATTACHMENT'
,p_prn_document_header=>'APEX'
,p_prn_units=>'INCHES'
,p_prn_paper_size=>'LETTER'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(263066139268062012)
...
,p_download_formats=>'CSV:HTML:EMAIL:XLS:PDF:RTF'
,p_owner=>'DIRK'
,p_internal_uid=>263066139268062012
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(263066479932062015)
,p_db_column_name=>'PACKAGE_OWNER'
,p_display_order=>30
,p_column_identifier=>'C'
,p_column_label=>'Package Owner'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(263066591636062016)
,p_db_column_name=>'PACKAGE_NAME'
,p_display_order=>40
,p_column_identifier=>'D'
,p_column_label=>'Package Name'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(263066640984062017)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(263066720148062018)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(263066832999062019)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(263066988065062020)
,p_db_column_name=>'NESTED_TABLE'
,p_display_order=>80
,p_column_identifier=>'H'
,p_column_label=>'Nested Table'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(263067090767062021)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(263067138597062022)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(263068789241062038)
,p_db_column_name=>'TYPE_OBJECT_TYPE'
,p_display_order=>110
,p_column_identifier=>'K'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(263976363760306715)
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'PACKAGE_OWNER:PACKAGE_NAME:TYPE_NAME:ITEM_NAME:ITEM_TYPE:ITEM_SEQUENCE:INDEX_BY:NESTED_TABLE:TABLE_TYPE:TYPE_OBJECT_TYPE::DATA_TYPE'
);
wwv_flow_api.create_page_plug(
...
,p_download_formats=>'CSV:HTML:EMAIL:XLS:PDF:RTF'
,p_owner=>'DIRK'
,p_internal_uid=>263404161844861777
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(263406130294861786)
,p_db_column_name=>'TYPE_NAME'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'Type Name'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(263406509986861786)
,p_db_column_name=>'ITEM_NAME'
,p_display_order=>6
,p_column_identifier=>'F'
,p_column_label=>'Item Name'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(263406972375861786)
,p_db_column_name=>'ITEM_TYPE'
,p_display_order=>7
,p_column_identifier=>'G'
,p_column_label=>'Item Type'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(263407378529861786)
,p_db_column_name=>'NESTED_TABLE'
,p_display_order=>8
,p_column_identifier=>'H'
,p_column_label=>'Nested Table'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(263407718827861787)
,p_db_column_name=>'TABLE_TYPE'
,p_display_order=>9
,p_column_identifier=>'I'
,p_column_label=>'Table Type'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(263068634925062037)
,p_db_column_name=>'TYPE_OBJECT_TYPE'
,p_display_order=>29
,p_column_identifier=>'K'
,p_column_label=>'Type Object Type'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(263976297718306714)
,p_db_column_name=>'DATA_TYPE'
,p_display_order=>69
,p_column_identifier=>'O'
,p_column_label=>'Data Type'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(263976066655306712)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(263065749850062008)
...
,p_name=>'P20_LAST_REFRESH_DATE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(263065749850062008)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(263067342773062024)
,p_computation_sequence=>20
,p_computation_item=>'P20_LAST_REFRESH_DATE'
,p_computation_point=>'BEFORE_BOX_BODY'
,p_computation_type=>'QUERY'
,p_computation=>'SELECT TO_CHAR(MAX(LAST_REFRESH_END_TIME),''DD.MM.YYYY HH24:MI:SS'') FROM USER_MVIEWS WHERE MVIEW_NAME = ''MV_PACKAGE_RECORD_TYPES'''
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(263976129787306713)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Refresh Report'
,p_process_sql_clob=>'package_tracer.Refresh_After_DDL_Job;'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(263976066655306712)
);
end;
/
...
/
prompt --application/deployment/install/install_package_tracer_head
begin
wwv_flow_api.create_install_script(
 p_id=>wwv_flow_api.id(263953676315948786)
,p_install_id=>wwv_flow_api.id(261939340346429622)
,p_name=>'package_tracer_head'
,p_sequence=>20
,p_script_type=>'INSTALL'
,p_script_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/*',
...
/
prompt --application/deployment/install/install_package_tracer_body
begin
wwv_flow_api.create_install_script(
 p_id=>wwv_flow_api.id(263953810352951150)
,p_install_id=>wwv_flow_api.id(261939340346429622)
,p_name=>'package_tracer_body'
,p_sequence=>30
,p_script_type=>'INSTALL'
,p_script_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/*',
...
unistr('                ''DBMS_LOB''  				-- PLS-00452: Unterprogramm ''DBFS_LINK_GENERATE_PATH'' verst\00F6\00DFt gegen sein zugeordnetes Pragma'),
'             )',
'            order by SYN.SYNONYM_NAME',
'        ) loop ',
'            pipe row (cur);',
...
wwv_flow_api.append_to_install_script(
 p_id=>wwv_flow_api.id(263953810352951150)
,p_script_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'ase when v_proc_tbl(ind).ARGS_COUNT > 0 then ''('' || v_proc_tbl(ind).CALL_PARAMETER || '')'' end ',
'                        || '';'' || chr(10) ',
...
/
prompt --application/deployment/install/install_package_tracer_init
begin
wwv_flow_api.create_install_script(
 p_id=>wwv_flow_api.id(263993741323867897)
,p_install_id=>wwv_flow_api.id(261939340346429622)
,p_name=>'package_tracer_init'
,p_sequence=>40
,p_script_type=>'INSTALL'
,p_script_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'begin ',
